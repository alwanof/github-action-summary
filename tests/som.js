...
test('User should be able to access somnium page', async t => {
    ...
    console.log("+Trying to read: somnium title");
    await  t
        .expect(somPage.title.textContent).eql(`${data.metasom.title}`);


    console.log("+Trying to read: somnium total land");
    ...
    console.log("+Trying to read: somnium land for sale");
    ...
    console.log("+Trying to read: somnium floor price");
...
test('On somniumspace, User should be able to access land popup details from the list', async t => {
    ...
    console.log("+Trying to click somnium list item");
    await t
    .click(somPage.listItem);
 
    console.log("+Trying to read: somnium land popup details");
...
test('On somniumspace, User should be able to see map', async t => {  
    ...
    console.log("+Trying to fetch: somnium map");
    await t
    .wait(12000)
